...
class _DispatchingConfigWrapper(DictMixin):
    ...
    the underlying DispatchingConfig config object, which is an 
    application local proxy that allows for multiple TG2 applications 
    to live in the same process simultaneously, but to always get 
    the right config data for the application that's requesting them.
    """
    ...
    def __getattr__(self, key):
        ...
        If it fails too it looks for an attr of the configurator
        becouse of it looks for update_blueprint somewhere
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    return getattr(self.config_proxy\
                            .current_conf()['tg.configurator'](), key)
